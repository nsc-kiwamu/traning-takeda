...
*/
 ...
 const sampleList:CompanyEmployee[] = [userY, userZ]
 for (const user of sampleList) {
...
/* 3. Common09を参考に以下の要素を持つ、typeであるFruitを作成する
   ...
   　りんごは赤いです
*/
 const sampleFruitList:Fruit = {name:'りんご',color:'赤い'}
 console.log(`${sampleFruitList.name}は${sampleFruitList.color}です`)
